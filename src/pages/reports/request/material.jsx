...
export default function ReportsRequestMaterial() {
  ...
  const [materialName, setMaterialName] = React.useState("all");
    ...
    <>
      ...
      <Box sx={{ p: 2 }}>
        ...
        <RowDdlSimple
          md={2}
          text="Material Name"
          ddlValue={materialName}
          ddlValues={dummyDdlAll}
          ddlOnChange={(e) => setMaterialName(e.target.value)}
        />
        <MainTableMenu
